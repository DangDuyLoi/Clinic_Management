...
CREATE TABLE BacSi (
    ...
    ma_tk INT UNIQUE, -- Khóa ngoại 1-1 với TaiKhoan
    ma_chuyen_khoa INT,
...
CREATE TABLE BenhNhan (
    ...
    ma_tk INT UNIQUE NULL, -- Có thể NULL nếu là khách vãng lai
    ho_ten VARCHAR(100) NOT NULL,
    ngay_sinh DATE,
...
CREATE TABLE CaLamViec (
    ...
    ten_ca VARCHAR(50) NOT NULL, -- Sáng, Chiều
...
CREATE TABLE KhungGio (
    ...
    gio_bat_dau TIME NOT NULL,
    gio_ket_thuc TIME NOT NULL,
    luot_kham_toi_da INT DEFAULT 3, -- VD: Mỗi 30p khám tối đa 3 bệnh nhân
...
CREATE TABLE LichKham (
    ...
    thoi_gian_den_quay TIME NULL, -- Dùng khi Lễ tân Check-in
...
CREATE TABLE PhienKham (
    ...
    ma_lich_dat INT UNIQUE NOT NULL, -- 1 Lịch khám sinh ra 1 Phiên khám
...
-- Bảng trung gian: Chỉ định dịch vụ cho phiên khám
...
-- 3. Thêm Bác sĩ 
INSERT INTO BacSi (ma_tk, ma_chuyen_khoa, ho_ten, trinh_do, luot_kham_toi_da_moi_ca) VALUES 
(2, 2, 'Hoàng Minh Tuấn', 'Thạc sĩ - Bác sĩ chuyên khoa II', 20);
...
-- 9. Thêm Danh mục Dịch vụ và Chỉ định
...
-- 10. Thêm Danh mục Thuốc và Đơn thuốc 
